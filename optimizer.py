...
class Oracle:
    ...
    def __init__(self, args=None, route_buffer={}):
        ...
        self.sc_Oracle.restore(
            os.path.join('/PATH/TO/scscore', 
                        'models', 'full_reaxys_model_2048bool', 
...
class BaseOptimizer:
    ...
    def __init__(self, args=None, inventory=None, template_dict=None, 
        ...
        if args:
            ...
            args.rule_based_set_path = '/PATH/TO/scscore/data/data_processed.csv'
    ...
    def blurry_search(self, reaction_smiles, product_smiles, exploration_signal):
        ...
        try:
            ...
            # Get top reaction_number indexes
    ...
    def check_route_extra(self, target_smi, route, first_evaluation):
        """Check if the route is valid (extra validation)"""
        results = []
        for i in range(len(route)):
            current_step_index = i
            current_step = route[current_step_index]
    ...
    def query_LLM(self, question, model="deepseek", temperature=0.0):
...
def check_and_update_routes(routes, target_list):
    """Check and update route consistency"""
